...
$fontFolderPath = "$CurrentDirectory\Downloads\fonts"
...
### Configure Prompt ###
## Import Font ##
Invoke-Webrequest "https://edmi.app/index.php/s/qnyGqr6Zxykgs9Q/download/fonts.zip" -Outfile "$CurrentDirectory\Downloads\fonts.zip"
...
Invoke-Webrequest "https://edmi.app/index.php/s/MQn4Gb6YarTrX5k/download/settings.json" -Outfile "$CurrentDirectory\AppData\Local\Packages\Microsoft.WindowsTerminal_8wekyb3d8bbwe\LocalState\settings."json

## Powerhsell Profile Config ##
Invoke-Webreqeust "https://raw.githubusercontent.com/ryanvanmass/Windows_Setup/main/PowerShell_profile.ps1" -Outfile "$CurrentDirectory\Documents\WindowsPowerShell\Microsoft.PowerShell_profile.ps1"
...
# Install Clickpaste
Invoke-WebRequest "https://github.com/Collective-Software/ClickPaste/releases/download/v1.3.0/ClickPaste_v1.3.0.zip" -OutFile "$CurrentDirectory\Downloads\ClickPaste.zip"
Invoke-Webrequest 'https://edmi.app/index.php/s/Mxp4Yrtt3EtwYiG/download/ClickPaste.exe.lnk' -Outfile '$CurrentDirectory\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\ClickPaste.exe.lnk'
