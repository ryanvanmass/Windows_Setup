...
Write-Output "oh-my-posh init pwsh --config "C:\Users\ryan\Downloads\Theme.omp.json" | Invoke-Expression" >> C:\Users\ryan\Documents\WindowsPowerShell\Microsoft.PowerShell_profile.ps1
