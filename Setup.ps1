...
#Write-Output "oh-my-posh init pwsh --config "C:\Users\ryan\Downloads\Theme.omp.json" | Invoke-Expression" >> C:\Users\ryan\Documents\WindowsPowersShell\Microsoft.PowerShell_profile.ps1
Invoke-WebRequest http://edmi.vanmassenhoven.com/index.php/s/n2P7q6mb7RLSrJQ/download/Microsoft.PowerShell_profile.ps1 -OutFile C:\Users\ryan\Documents\WindowsPowersShell\Microsoft.PowerShell_profile.ps1
